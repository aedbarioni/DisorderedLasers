...
parfor jj = 1:trial
    ...
    for ii = 1:m
        ...
        if found == 1 % Sync state identified successfully
            ...
            % % Added to calculate other measures of stability such as
            % standard deviation of the power spectrum peaks 'stdFFT'.
            % [stdFFT,Ptot,OrderCoh] = LaserDyn(r,Omega,delta,N,param_h,het_choice,param);
            Sol_m{jj,ii} = sol;
